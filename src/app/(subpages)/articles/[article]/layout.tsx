...
export default function ArticlesLayout({
  ...
  return (
    <>
      ...
      <footer className="px-12 mt-48 grid grid-cols-3 gap-px bg-yellow-100 border border-yellow-100">
        {[
          ...
          <Link
            key={resource.name}
            href={resource.url}
            className="group relative bg-yellow-600 p-6 hover:pl-10 flex flex-col justify-between gap-8 hover:bg-yellow-400 transition-all duration-200"
          >
            ...
            <span className="font-mono text-xs uppercase tracking-[0.2em] text-yellow-800 group-hover:text-stone-800">
              {resource.type}
            </span>
